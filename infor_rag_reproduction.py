"""
# modified from train_infor_rag and hf by FAWKES
# coding=utf-8
# Copyright 2020-present the HuggingFace Inc. team and Infor-RAG team
#
...
class InforRAGTrainer(Trainer):
    ...
    def _inner_training_loop(
        ...
        # Train!
        logger.info("***** Running training using InforRAG Trainer *****")
